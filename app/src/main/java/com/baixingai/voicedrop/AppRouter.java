...
public final class AppRouter {
    ...
    public static DeepLink parse(Uri uri) {
        ...
        return parseParts(uri.getScheme(), route, first);
    }
    ...
    public static DeepLink parse(String raw) {
        ...
        try {
            ...
            return parseParts(uri.getScheme(), uri.getHost() == null ? "" : uri.getHost(), first);
        } catch (Exception e) {
            return DeepLink.none();
        }
    }

    private static DeepLink parseParts(String scheme, String route, String firstSegment) {
        ...
        if ("record".equals(route)) return new DeepLink(Kind.RECORD, "");
    ...
    public static final class DeepLink {
        ...
        DeepLink(Kind kind, String stem) {
            this.kind = kind;
