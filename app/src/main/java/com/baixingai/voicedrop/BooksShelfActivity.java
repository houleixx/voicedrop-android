...
public final class BooksShelfActivity extends Activity {
    ...
    private View bookCell(BookShelfIndex.Book book) {
        LinearLayout cell = new LinearLayout(this); cell.setOrientation(LinearLayout.VERTICAL); cell.setOnClickListener(v -> BookReaderActivity.open(this, book.slug, book.main));
