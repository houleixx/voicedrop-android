...
public final class PromptImportActivity extends VoiceDropActivity {
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        importButton = new Button(this); importButton.setText(com.baixingai.voicedrop.ui.I18n.text(this, "确认导入")); importButton.setEnabled(false); importButton.setOnClickListener(v -> importPrompt()); page.addView(importButton);
        Button cancel = new Button(this); cancel.setText(com.baixingai.voicedrop.ui.I18n.text(this, "取消")); cancel.setOnClickListener(v -> finish()); page.addView(cancel);
        setContentView(page);
    ...
    private void loadPreview(String code) {
        preview.setText(com.baixingai.voicedrop.ui.I18n.text(this, "正在读取…")); importButton.setEnabled(false);
        io.execute(() -> {
            ...
            runOnUiThread(() -> {
                ...
                String author = result.author.isEmpty() ? "" : "\n" + com.baixingai.voicedrop.ui.I18n.text(this, "分享者：") + result.author;
                preview.setText(result.label + author + "\n\n" + result.prompt + "\n\n"
                        + com.baixingai.voicedrop.ui.I18n.text(this, "已被导入 ") + result.importCount
                        + com.baixingai.voicedrop.ui.I18n.text(this, " 次"));
    ...
    private TextView text(String value, int sp) { TextView v = new TextView(this); v.setText(com.baixingai.voicedrop.ui.I18n.text(this, value)); v.setTextSize(sp); v.setTextColor(Theme.INK); v.setPadding(0, dp(8), 0, dp(8)); return v; }
