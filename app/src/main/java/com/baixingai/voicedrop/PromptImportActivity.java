...
public final class PromptImportActivity extends Activity {
    ...
    @Override protected void onCreate(Bundle state) {
        ...
        LinearLayout page = new LinearLayout(this); page.setOrientation(LinearLayout.VERTICAL); SystemBarDefaults.applyTopInsets(page, dp(22), dp(10), dp(22), dp(24)); page.setBackgroundColor(Theme.BG);
