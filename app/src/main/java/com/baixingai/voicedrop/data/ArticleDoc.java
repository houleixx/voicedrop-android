...
public final class ArticleDoc {
    ...
    public static ArticleDoc fromJson(String json) throws Exception {
        ...
        return new ArticleDoc(obj.optString("id", null), obj.optString("transcript", null), articles, tags, photos,
